...
Route::group(
    ...
    function () { //...
        ...
        Route::get('/home', 'branchViewController@home')->middleware('auth')->name('home');
        Route::get('/BranchList', 'branchViewController@index')->middleware('auth')->name('BranchList');
        Route::get('/branch/create', 'branchViewController@create')->middleware('auth')->name('branch.create');
        Route::post('/create/branch', 'branchViewController@store')->middleware('auth');
        Route::get('/branchEdit/{id}', 'branchViewController@edit')->middleware('auth')->name('branchEdit');
        Route::post('/branchEdit/{id}', 'branchViewController@update')->middleware('auth');
        Route::get('/destroy/{id}', 'branchViewController@destroy')->middleware('auth')->name('destroy');

        Route::get('/BillsDaily', 'billsDailyController@index')->middleware('auth')->name('BillsDaily');
        Route::post('/showBillDaily', 'billsDailyController@show')->middleware('auth')->name('showBillDaily');

        Route::get('/BillsNumForEachBranch', 'billKindController@index')->middleware('auth')->name('BillsNumForEachBranch');
        Route::post('/showBillNumber', 'billKindController@show')->middleware('auth')->name('showBillNumber');

        Route::get('/ReportsSales', 'RepoSalController@index')->middleware('auth')->name('ReportsSales');
        Route::post('/showReportsSales', 'RepoSalController@show')->name('showReportsSales')->middleware('auth');

        Route::get('/DetailesSalse', 'DetSalController@index')->middleware('auth')->name('DetailesSalse');
        Route::post('/showDelSal', 'DetSalController@show')->middleware('auth')->name('showDelSal');

        Route::get('/RepSalMats', 'repoMatsSaleController@index')->middleware('auth')->name('RepSalMats');
        Route::post('/showRepSalMats', 'repoMatsSaleController@show')->middleware('auth')->name('showRepSalMats');

        Route::get('/sellingMoreItems', 'sellingMoreItemsController@index')->middleware('auth')->name('sellingMoreItems');
        Route::post('/showsellingMoreItems', 'sellingMoreItemsController@show')->middleware('auth')->name('showsellingMoreItems');

        Route::get('/sellingLesseItems', 'sellingLesseItemsController@index')->middleware('auth')->name('sellingLesseItems');
        Route::post('/showsellingLesseItems', 'sellingLesseItemsController@show')->middleware('auth')->name('showsellingLesseItems');

        Route::get('/matsElementConsuming', 'matsElementConsumingController@index')->middleware('auth')->name('matsElementConsuming');
        Route::post('/showmatsElementConsuming', 'matsElementConsumingController@show')->middleware('auth')->name('showmatsElementConsuming');
