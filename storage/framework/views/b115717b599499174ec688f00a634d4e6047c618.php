...
<?php echo e(__('message.More Item Sales')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.More Item Sales')); ?></h4>
            </div>
            <div class="card-body ">
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('showsellingLesseItems')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
            ...
            <div id="results" class="card">
                ...
                <div class="card-body ">
                    <table id="morItem-table" class="table table-striped table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
...
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rest3\resources\views/POS/moreItemsSales.blade.php ENDPATH**/ ?>