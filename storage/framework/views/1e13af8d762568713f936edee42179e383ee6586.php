...
<?php echo e(__('message.Add New BillKind')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.Add New BillKind')); ?></h4>
            </div>
            <div class="card-body ">
                    ...
                    <?php endif; ?>
                <form method="Post" action="<?php echo e(route('billKind.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\report\resources\views\billKind\create.blade.php ENDPATH**/ ?>