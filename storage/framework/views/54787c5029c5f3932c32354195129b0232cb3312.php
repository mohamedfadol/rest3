                ...
                <form method="POST" action="<?php echo e(route('billKind.update',$billKind->id)); ?>">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input type="number" name="BillKindNumber" class="form-control" id="BillKindNumber" value="<?php echo e($billKind->BillKindNumber); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input type="text" name="BillKindName" class="form-control" id="BillKindName" value="<?php echo e($billKind->BillKindName); ?>">
                        </div>
                    </div>
