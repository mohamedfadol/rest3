...
<?php echo e(__('message.Categories Sales Report')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.Categories Sales Report')); ?></h4>
            </div>
            <div class="card-body ">
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('reports.categoriesSales')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 mt-4">
                            <label class="bmd-label" for="category"><?php echo e(__('message.Category')); ?></label>
                    ...
                    <table id="categories-table" class="table table-striped table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('message.Product')); ?></th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!in_array($key, ['category', 'total'])): ?>
                                        <tr>
                                            <td colspan="2"></td>
                                            <td><?php echo e($product->first()->nameEn); ?></td>
                                            <td><?php echo e($product['totalQuantity']); ?></td>
                                            <td><?php echo e(number_format($product->first()->price)); ?></td>
                                            <td><?php echo e(number_format($product->first()->price * $product['totalQuantity'])); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\report\resources\views\reports\categories-sales.blade.php ENDPATH**/ ?>