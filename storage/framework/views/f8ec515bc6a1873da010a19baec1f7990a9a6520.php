...
<?php echo e(__('message.Add a Employee')); ?>
...
<div class='col-lg-4 col-lg-offset-4'>
    ...
    <h1><i class='fa fa-user-plus'></i> <?php echo e(__('message.Add a Employee')); ?></h1>
        ...
        <?php endif; ?>
    <form action="<?php echo e(route('employees.store')); ?>" method="POST" accept-charset="utf-8">
        <?php echo csrf_field(); ?>
