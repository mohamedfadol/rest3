...
<?php echo e(__('message.Report Of Sales Branch')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.Report Of Sales Branch')); ?></h4>
            </div>
            <div class="card-body ">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr  class="text-center">
                                    ...
                                    <td><?php echo e($totalsum = $branch->ordersSum($startDate,$endDate)); ?></td>
                                    <td><?php echo e($totsum += $branch->ordersSum($startDate,$endDate)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td> <?php echo e(__('message.Net')); ?> </td>
                                <td>  </td>
                                <td><?php echo e($totsum); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rest3\resources\views/POS/RepoSal.blade.php ENDPATH**/ ?>