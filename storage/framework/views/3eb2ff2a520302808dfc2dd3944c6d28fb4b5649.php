...
<?php echo e(__('message.Edit An Delevery')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.Edit An Delevery')); ?></h4>
            </div>
            <div class="card-body ">
                    ...
                    <?php endif; ?>
                <form id="delivery-form" method="POST" action="<?php echo e(route('delevery.update',$delevery->id )); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input id="name" type="text" value="<?php echo e($delevery->name); ?>" class="form-control" name="name" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input type="text" value="<?php echo e($delevery->phone); ?>" class="form-control" id="phone" name="phone" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input type="text" value="<?php echo e($delevery->motortype); ?>" class="form-control" id="motortype" name="motortype" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mt-4">
                            ...
                            <input type="number" value="<?php echo e($delevery->number); ?>" class="form-control" id="number" name="number" required>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\report\resources\views/deleveries/edit.blade.php ENDPATH**/ ?>