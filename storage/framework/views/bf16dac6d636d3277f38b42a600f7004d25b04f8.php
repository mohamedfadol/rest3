...
<?php echo e(__('message.Ingredients Sales Report')); ?>
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title"><?php echo e(__('message.Ingredients Sales Report')); ?></h4>
            </div>
            <div class="card-body ">
            ...
            <div id="results" class="card">
                ...
                <div class="card-body ">
                    ...
                    <table id="categories-table" class="table table-striped table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th><?php echo e(__('message.Ingredient')); ?></th>
