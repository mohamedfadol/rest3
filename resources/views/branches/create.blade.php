    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('message.Add New Branch') }}</h4>
            </div>
            <div class="card-body ">
                    @if (count($errors) > 0)
...
<!--                     <div id="address-map-container" style="width:100%;height:400px; ">
                        ...
                        <div class="col-sm-10 checkbox-radios">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" onchange="handleDeliveryPrice()" type="radio" name="delivery_price" value="dinamic" checked> {{ __('message.Open') }}
                                        <span class="circle">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" onchange="handleDeliveryPrice()" type="radio" name="delivery_price" value="static"> {{ __('message.Pre') }}
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
                   ...
                   <div class="row">
                        ...
                        <div class="card-footer ">
                            <button type="submit" class="btn btn-fill btn-rose">{{ __('message.Add New') }}</button>
