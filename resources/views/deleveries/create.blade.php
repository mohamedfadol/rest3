    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('message.Add New delevery') }}</h4>
            </div>
            <div class="card-body ">
                    @if (count($errors) > 0)
                    ...
                    @endif
                <form id="delivery-form" method="POST" action="{{ route('delevery.store') }}" enctype="multipart/form-data">
                    @csrf
